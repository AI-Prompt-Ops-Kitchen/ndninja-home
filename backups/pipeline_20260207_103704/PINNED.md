...
- **Reference Image (video):** `assets/reference/ninja_helmet_v3_futuristic.jpg` (futuristic newsroom)
- **Reference Image (thumbnail):** `assets/reference/ninja_helmet_v3_futuristic.jpg`
- **Vertex AI Project:** `gen-lang-client-0601509945`

### Video Generation Stack (2026-02-06)
1. **TTS:** Remix voice + eleven_v3 + timestamps API
2. **Avatar:** Kling Avatar v2 + helmet image
3. **Captions:** Character-level timestamps from ElevenLabs (perfect sync)

### Old Config (deprecated)
- Voice: `pDrEFcc78kuc76ECGkU8` (original PVC - doesn't work with V3)
- Image: `ninja_news_anchor.jpg` (has lip-sync mouth bleed-through)

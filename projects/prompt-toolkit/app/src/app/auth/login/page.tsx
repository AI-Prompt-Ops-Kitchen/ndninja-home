...
export default function LoginPage() {
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-gray-950 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 right-[20%] w-64 h-64 bg-purple-600/[0.05] rounded-full blur-3xl" />
      ...
      >
        ...
        <div className="text-center">
          ...
          <p className="text-sm text-gray-400 mt-3">Welcome back</p>
        </div>
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="rounded border-gray-700 bg-gray-900 text-indigo-600 focus:ring-indigo-600/50 h-4 w-4" />
            ...
            <Button className="w-full shadow-lg shadow-indigo-600/20" size="lg">Sign In</Button>
          </form>
        </div>

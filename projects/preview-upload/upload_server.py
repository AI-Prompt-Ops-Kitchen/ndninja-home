...
Container-aware: reads UPLOADS_DIR from env var."""
import os
import re
import html as html_mod
from http.server import HTTPServer, BaseHTTPRequestHandler

UPLOAD_DIR = os.environ.get("UPLOADS_DIR", "/home/ndninja/uploads")
...
print(f"Upload server running on http://0.0.0.0:8082")
